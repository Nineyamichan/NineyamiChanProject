...
<style type="text/css">* {cursor: url(http://ani.cursors-4u.net/symbols/sym-9/sym828.ani), url(http://ani.cursors-4u.net/symbols/sym-9/sym828.png), auto !important;}</style><a href="http://www.cursors-4u.com/cursor/2018/02/17/dancing-red-rose.html" target="_blank" title="Dancing Red Rose"><img src="http://cur.cursors-4u.net/cursor.png" border="0" alt="Dancing Red Rose" style="position:absolute; top: 0px; right: 0px;" /></a>
                ...
                <br>
                <br>
 <center> <img src="http://gibsy.g.i.pic.centerblog.net/2525237whh10dl9sw.gif" alt="some text" width=350 height=250> </center>
 
  <body background="https://scene360.com/wp-content/uploads/2015/08/candice-tripp-07.jpg"   >
...
<form action="CadastroBD.php" method="POST"> 
    ...
    <th colspan="2">  Cadastro - Seja bem vindo! </th> 
<tr>
                     
    <td bgcolor="#BDBDBD"> Seu nome: </td> <td> <input type="text" name="Nome" placeholder="Insira o seu nome"  size="60" required="" > </td> <br>
        
            </tr>
                       <tr> 
                    <td bgcolor="#BDBDBD"> Senha:  </td>
                    <td> <input type="password" name="senha" placeholder="Informe a senha, por favor"  size="60"  required="" accept="" >
                    </td> <br> 
                       </tr>
                       <tr>            
                    <td bgcolor="#BDBDBD"> E-mail:  </td>
                    <td><input type="text" name="email" placeholder="Informe seu e-mail, por favor" size="60"  required=""> </td> <br> 
                 
 </tr>
                    <tr>
                        <tr>  <td>            
 <p> Já é cadastrado?  <a href="http://localhost/PhpProject2/Login.php" > Faça seu Login </a>  </p>  </td> </tr>
   ...
   <form action="CadastroBD.php" method="POST"> 
            ...
            <center>
                ...
                <table  BACKGROUND="https://i.pinimg.com/originals/6a/5a/eb/6a5aeb7b6f401e6b6d5ba4d50d91021e.png" border="2">
